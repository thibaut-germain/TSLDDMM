...
if __name__ == "__main__": 
    ...
    p0s,q0,q0_mask = batch_barycenter_registration(bX,bX_mask,Kv,dataloss,qi,qi_mask,niter=200,optimizer=optimizer,gamma_loss=1e-3)

    np.save("./results/exp_2_lddmm_1/idxs.npy",idxs)
    np.save("./results/exp_2_lddmm_1/p0s.npy",p0s)
    np.save("./results/exp_2_lddmm_1/q0.npy",q0)
    np.save("./results/exp_2_lddmm_1/q0_mask.npy",q0_mask)