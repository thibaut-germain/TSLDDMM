...
\begin{abstract}
    ...
    The idea is to represent time series as the deformation of a time series of reference using Large Deformation Diffeomorphic Metric Mapping (LDDMM).
     Once the deformations and time series of reference are learned, the vector representations of time series are then given by the parametrization of the deformation.
     At the crossroads between URL for time series and shape analysis, the proposed algorithm manages irregularly sampled multivariate time series of variable lengths and provides shape-based representations of temporal data. 
