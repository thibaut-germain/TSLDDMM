...
\item {\bf Theory Assumptions and Proofs}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: The optimization methodology is described in \Cref{section:methodology} and all numerical details and protocol are given in \Cref{section:experiments} and in \Cref{appendix: settings_classification}-\ref{appendix:optimizers_details}-\ref{appendix:numerics_synthetic}-\ref{appendix: settings_classification}.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf Experimental Setting/Details}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: The experiments setting is clearly presented in \Cref{section:experiments} for the experiments on the mouse dataset. The full details of all experiments are presented in \Cref{appendix: benchmark robustness}-\ref{appendix:optimizers_details}-\ref{appendix:numerics_synthetic}-\ref{appendix: settings_identifiability}.
    \item[] Guidelines:
    \begin{itemize}
        \item The answer NA means that the paper does not include experiments.
