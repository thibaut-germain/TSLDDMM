...
\item {\bf Theory Assumptions and Proofs}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: The optimization methodology is described in \Cref{section:methodology} and all numerical details and protocol are given in \Cref{section:experiments} and in \Cref{appendix:optimizers_details}-\ref{appendix: identifiability}-\Cref{appendix: robustness}-\Cref{appendix: shape_classification}--\Cref{appendix: mice_exp_setting}.
    \item[] Guidelines:
    \begin{itemize}
